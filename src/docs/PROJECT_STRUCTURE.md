...
│       │   ├── select_menu/              # 选择菜单
│       │   ├── wave_flag/                # 波次旗帜
│       │   ├── entity_info_bar.gd        # 实体信息栏
│       │   ├── game_ui_layer.gd          # 游戏UI层
│       │   ├── player_resources.gd       # 玩家资源
│       │   └── speed_button.gd           # 速度按钮
│       ├── main/                         # 主界面
│       │   ├── main.gd                   # 主界面脚本
│       │   ├── play_button.gd            # 开始按钮
│       │   ├── quit_button.gd            # 退出按钮
│       │   ├── setting_button.gd         # 设置按钮
│       │   └── wave_editor_button.gd     # 波次编辑器按钮
│       ├── map/                          # 地图界面
│       ├── wave_editor/                  # 波次编辑器
│       │   ├── load_button.gd            # 加载按钮
